...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["editBtn"])) {
        ...
        try {
            TeacherBLL::updateTeacher($teacher->getID(), $name, $email, $password, $gender, $address, $phoneNumber, $birthday);
            echo '<script>
...
<body>
    <div class="mainContainer">
        ...
        <div class="imageView">
            <img src="../../../resources/image/teacher.png" alt="">
        </div>
            ...
            <form class="editView" action="" method="POST">
                <table class="infoTB">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="textField" name="name" id="" value="<?php echo TeacherBLL::getTeacherName(); ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>Email</th>
                        <td>
                            <input type="text" class="textField" name="email" value="<?php echo TeacherBLL::getTeacherEmail(); ?>" placeholder="Enter email" required>
                        </td>
                    </tr>
